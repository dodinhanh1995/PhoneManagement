<%@ Page Title="Điện thoai di động, smartphone chính hãng | AnhDo Mobile" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Phone.aspx.cs" Inherits="PhoneManagement.Phone" %>
            ...
            <nav class="navbar navbar-inverse margin_top10">
                ...
                <div class="col-md-2 pull-right">
                    <h6 class="lead text-right">
                        <asp:Label EnableViewState="false" ID="lblTotalRecords" runat="server" Font-Bold="True" ForeColor="White"></asp:Label></h6>
                </div>
            </nav>
            <!-- End Menu Filter -->
                ...
                <ItemTemplate>
                    <div class="col-md-2 text-center sub-box-product">
                        <a href='<%# Eval("name_url", "dien-thoai-{0}") %>' title='<%# Eval("name") %>'>
                            <img src='<%# Eval("picture", "public/upload/products/{0}") %>' alt='<%# Eval("name") %>' title='<%# Eval("name") %>' />
                        </a>
                        <hr />
                        <strong>
            ...
            <div class="clearfix text-center">
                <ul class="pagination">
                    <asp:Repeater ID="rptPagination" runat="server" OnItemCommand="rptPagination_ItemCommand">
                        <ItemTemplate>
                            <li>
                                <asp:LinkButton ID="lbtnPage" CommandName="Page" CommandArgument="<%# Container.DataItem %>" runat="server">
                            <%# Container.DataItem %>
                                </asp:LinkButton>
                            </li>
                        </ItemTemplate>
